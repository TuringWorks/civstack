...
│   ├── excellence-map-levers.md          # route capability constraints to JTBD, roles, and verified outcomes
...
```bash
# rebuild it (after cloning or editing skills):
python3 tools/build_site.py

# then either just open it…
open site/index.html            # works straight from file://

# …or serve it:
python3 -m http.server -d site 8000     # http://localhost:8000
```

To host it for others, point **GitHub Pages** at the `site/` folder, or copy `site/` to any
static host. See [`site/README.md`](site/README.md).
