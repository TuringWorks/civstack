...
> **Personnel type:** AI agent · **Human supervisor:** asset manager
...
Trigger this skill when the task involves any of: schedules inspection and renewal of network assets. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: schedules inspection and renewal of network assets.
...
- **Human (asset manager)** — owns goals, exceptions, relationships, and signoff.
