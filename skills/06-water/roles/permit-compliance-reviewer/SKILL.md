...
Trigger this skill when the task involves any of: checks discharge and abstraction against permit limits. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: checks discharge and abstraction against permit limits.
