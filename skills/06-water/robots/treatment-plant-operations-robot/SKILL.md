---
name: "robot-06-treatment-plant-operations-robot"
description: "Humanoid/embodied robot role for the Water operating system: **Treatment plant operations robot** — patrol water and wastewater plants, read gauges, take samples, turn valves, and service pumps and dosing systems. Best in: water/wastewater treatment plants, pump stations, chemical dosing rooms. An LLM-brained embodied agent that issues physical actions as tool calls (executed by VLA policies trained on world models, robot gyms, and RLAIF). Use this skill to plan or operate this physical role in the water sector; trigger whenever the task needs this hands-on work, even if the user only describes the underlying need."
---

# Treatment plant operations robot

> **Operating system:** 06. Water, Sanitation, and Public Hygiene · **Personnel type:** LLM-brained embodied robot
> **Best environments:** water/wastewater treatment plants, pump stations, chemical dosing rooms
> **Sector skill:** `../../SKILL.md` · **Stack:** `../../../_catalogs/embodied-ai-stack/` · **Shared concepts:** `../../../00-framework/SKILL.md`

## What this role is

The **Treatment plant operations robot** is an embodied robot whose job is to patrol water and wastewater plants, read gauges, take samples, turn valves, and service pumps and dosing systems. Takes the physical rounds of plant operation: walking the process train, reading analog gauges legacy SCADA never captured, pulling grab samples, exercising valves, swapping dosing-pump heads, and clearing screens. Extends scarce certified operators across more assets and keeps humans out of chlorine rooms and confined spaces.
...
When a task needs the physical job "patrol water and wastewater plants, read gauges, take samples, turn valves, and service pumps and dosing systems" in environments such as water/wastewater treatment plants, pump stations, chemical dosing rooms. Pair with the sector skill (`../../SKILL.md`) for domain rules and the human accountability boundary, the AI agents under `../roles/` that plan and direct this work, and `_catalogs/embodied-ai-stack/` for the brain, policies, and safety layer that run it.
