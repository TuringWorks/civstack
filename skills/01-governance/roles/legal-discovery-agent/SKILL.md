...
- Perform the core function: reviews evidence, builds timelines, analyzes contracts, precedents, and filings.
...
- **Human (attorney)** — owns goals, exceptions, relationships, and signoff.
...
**In the job market, this agent maps to:** Paralegal, eDiscovery Analyst, Litigation Associate (support).

Employers typically list — **tools:** Relativity, Everlaw, Westlaw/LexisNexis, e-filing systems. **Qualifications/certs:** Paralegal certificate (NALA/NFPA); attorneys hold JD + state bar.

Posted on LinkedIn and bar-association boards; the agent reviews and organizes, counsel decides.
