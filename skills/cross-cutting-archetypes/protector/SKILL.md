...
Use it whenever you need to instantiate a **Protector** in any sector — to set up the role, divide the work across human/AI/robot, and wire in the right accountability. Combine with the relevant operating-system skill (01–22) for domain specifics.
