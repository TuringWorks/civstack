...
Use it whenever you need to instantiate a **Scientist** in any sector — to set up the role, divide the work across human/AI/robot, and wire in the right accountability. Combine with the relevant operating-system skill (01–22) for domain specifics.
...
- **AI personnel fit:** high for literature, modeling, experiment design.
- **Humanoid robot fit:** high for lab automation.
