...
Define, enforce, and audit rules.

## When to use this skill

Use it whenever you need to instantiate a **Regulator** in any sector — to set up the role, divide the work across human/AI/robot, and wire in the right accountability. Combine with the relevant operating-system skill (01–22) for domain specifics.
...
- **AI personnel fit:** high for evidence review and drafting.
- **Humanoid robot fit:** medium for field inspection support.
