...
- Perform the core function: models physical and transition climate risk.
...
- **Human (climate risk analyst)** — owns goals, exceptions, relationships, and signoff.
