...
- Perform the core function: tracks environmental permit obligations.
...
- **Human (environmental compliance specialist)** — owns goals, exceptions, relationships, and signoff.
