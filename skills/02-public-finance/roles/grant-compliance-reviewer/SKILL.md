...
> **Personnel type:** AI agent · **Human supervisor:** grants manager
...
Trigger this skill when the task involves any of: checks grant spending against terms and prepares findings. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: checks grant spending against terms and prepares findings.
...
- **Human (grants manager)** — owns goals, exceptions, relationships, and signoff.
