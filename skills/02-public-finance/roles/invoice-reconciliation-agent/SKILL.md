...
- Perform the core function: matches invoices, POs, and receipts and resolves exceptions.
...
- **Human (accounts-payable lead)** — owns goals, exceptions, relationships, and signoff.
