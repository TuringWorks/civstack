...
- Perform the core function: selects statistically defensible samples and assembles evidence.
...
- **Human (auditor)** — owns goals, exceptions, relationships, and signoff.
