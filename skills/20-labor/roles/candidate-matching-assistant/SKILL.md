...
- Perform the core function: screens and matches candidates to roles.
...
- **Human (recruiter)** — owns goals, exceptions, relationships, and signoff.
