...
- Perform the core function: monitors for falls and safety risks under oversight.
...
- **Human (care team)** — owns goals, exceptions, relationships, and signoff.
