...
- Perform the core function: coordinates appointments, records, and caregivers.
...
- **Human (eldercare coordinator)** — owns goals, exceptions, relationships, and signoff.
