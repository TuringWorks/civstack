...
- Perform the core function: manages consent artifacts and audits data sharing against policy.
...
- **Human (data protection officer)** — owns goals, exceptions, relationships, and signoff.
