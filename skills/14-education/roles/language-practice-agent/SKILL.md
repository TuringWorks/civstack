...
- Perform the core function: provides conversational language practice and correction.
...
- **Human (language teacher)** — owns goals, exceptions, relationships, and signoff.
