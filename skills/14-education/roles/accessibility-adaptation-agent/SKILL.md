...
- Perform the core function: adapts materials for accessibility needs.
...
- **Human (special education teacher)** — owns goals, exceptions, relationships, and signoff.
