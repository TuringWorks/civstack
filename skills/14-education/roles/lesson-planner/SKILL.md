...
- Perform the core function: drafts standards-aligned lessons and materials.
...
- **Human (teacher / curriculum designer)** — owns goals, exceptions, relationships, and signoff.
