...
> **Personnel type:** AI agent · **Human supervisor:** product/store manager
...
Trigger this skill when the task involves any of: summarizes customer reviews and surfaces issues. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: summarizes customer reviews and surfaces issues.
...
- **Human (product/store manager)** — owns goals, exceptions, relationships, and signoff.
