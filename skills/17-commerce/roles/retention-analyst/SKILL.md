...
> **Personnel type:** AI agent · **Human supervisor:** customer success manager
...
Trigger this skill when the task involves any of: predicts churn and recommends retention actions. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: predicts churn and recommends retention actions.
...
- **Human (customer success manager)** — owns goals, exceptions, relationships, and signoff.
