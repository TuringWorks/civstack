...
Trigger this skill when the task involves any of: detects defects and quality drift from inspection and sensor data. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: detects defects and quality drift from inspection and sensor data.
