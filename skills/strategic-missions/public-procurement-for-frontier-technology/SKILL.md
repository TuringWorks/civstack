...
- Domestic/allied supply-chain requirements.
- Scale-up pathways after pilots.
...
- Receiving/inventory robot.
- Testbed support robot.
- Inspection robot for physical pilots.

See `_catalogs/humanoid-robots/`, `_catalogs/autonomous-machines/`, and the sectors' `robots/` and `autonomous/` folders.

## Operating loop

1. Define mission outcome and constraints.
2. Survey market and technology readiness.
3. Draft outcome-based requirements with evaluation evidence.
4. Run transparent competition or challenge.
5. Pilot with safety, privacy, performance gates.
6. Scale strong vendors, terminate weak pilots.
7. Feed lessons into standards and budgets.
