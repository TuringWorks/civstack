...
> **Personnel type:** AI agent · **Human supervisor:** data steward
...
Trigger this skill when the task involves any of: detects anomalies, reconciles records, and maintains pipelines. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: detects anomalies, reconciles records, and maintains pipelines.
...
- **Human (data steward)** — owns goals, exceptions, relationships, and signoff.
