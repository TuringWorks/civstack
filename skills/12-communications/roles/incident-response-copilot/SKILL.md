...
- Perform the core function: assembles incident context and proposes response steps.
...
- **Human (incident responder)** — owns goals, exceptions, relationships, and signoff.
