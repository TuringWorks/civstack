...
- Perform the core function: analyzes instrument and assay data.
...
- **Human (research associate)** — owns goals, exceptions, relationships, and signoff.
