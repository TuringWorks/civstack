...
The jobs above are universal; how they are staffed is not. Transport is a network of networks under mixed control — public, private, and informal paratransit — where a local disruption propagates system-wide and safety regimes differ by mode.
