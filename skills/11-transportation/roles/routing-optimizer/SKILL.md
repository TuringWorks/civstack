...
> **Personnel type:** AI agent · **Human supervisor:** logistics coordinator
...
Trigger this skill when the task involves any of: optimizes routes and loads against time, cost, and constraints. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: optimizes routes and loads against time, cost, and constraints.
...
- **Human (logistics coordinator)** — owns goals, exceptions, relationships, and signoff.
