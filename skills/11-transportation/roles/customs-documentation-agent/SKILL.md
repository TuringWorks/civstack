...
- Perform the core function: prepares and checks customs and trade documentation.
...
- **Human (customs broker)** — owns goals, exceptions, relationships, and signoff.
