---
name: "maritime-route-weather-routing-agent"
description: "AI-personnel skill: **Maritime route & weather-routing agent** for the Transportation operating system. This agent plans sea routes and weather routing for vessels and monitors maritime traffic and safety. Use this skill whenever a task in this domain needs this work (plans sea routes and weather routing for vessels and monitors maritime traffic and safety) — even if the user describes the task plainly rather than naming the role. Operates under a human marine operations lead and stops at the sector's accountability boundary."
---
