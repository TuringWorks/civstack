...
- Perform the core function: optimizes storage slotting and pick paths.
...
- **Human (warehouse manager)** — owns goals, exceptions, relationships, and signoff.
