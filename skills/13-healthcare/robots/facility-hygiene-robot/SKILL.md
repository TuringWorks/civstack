---
name: "robot-13-facility-hygiene-robot"
description: "Humanoid/embodied robot role for the Healthcare operating system: **Facility hygiene robot** — clean, disinfect, and turn over patient rooms, operating theaters, and shared spaces. Best in: patient rooms, operating rooms, waiting areas, isolation units. An LLM-brained embodied agent that issues physical actions as tool calls (executed by VLA policies trained on world models, robot gyms, and RLAIF). Use this skill to plan or operate this physical role in the healthcare sector; trigger whenever the task needs this hands-on work, even if the user only describes the underlying need."
---

# Facility hygiene robot

> **Operating system:** 13. Healthcare, Public Health, and Biomedical Systems · **Personnel type:** LLM-brained embodied robot
> **Best environments:** patient rooms, operating rooms, waiting areas, isolation units
> **Sector skill:** `../../SKILL.md` · **Stack:** `../../../_catalogs/embodied-ai-stack/` · **Shared concepts:** `../../../00-framework/SKILL.md`

## What this role is

The **Facility hygiene robot** is an embodied robot whose job is to clean, disinfect, and turn over patient rooms, operating theaters, and shared spaces. Delivers verifiable, protocol-exact cleaning: terminal cleans between patients, UV or chemical disinfection cycles with coverage logging, isolation-room turnover without exposing staff, and high-touch-surface rounds. Cleaning verification data feeds infection-control agents directly.
