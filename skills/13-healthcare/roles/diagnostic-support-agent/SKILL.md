...
- Perform the core function: surfaces differential diagnoses and relevant evidence.
...
- **Human (physician)** — owns goals, exceptions, relationships, and signoff.
