---
name: "robot-07-line-crew-assistant-robot"
description: "Humanoid/embodied robot role for the Energy operating system: **Line-crew assistant robot** — stage materials, prepare hardware, dig and set poles, and support de-energized line construction and storm restoration. Best in: distribution corridors, storm-damage zones, rural line builds. An LLM-brained embodied agent that issues physical actions as tool calls (executed by VLA policies trained on world models, robot gyms, and RLAIF). Use this skill to plan or operate this physical role in the energy sector; trigger whenever the task needs this hands-on work, even if the user only describes the underlying need."
---

# Line-crew assistant robot

> **Operating system:** 07. Energy, Utilities, and Grid Operations · **Personnel type:** LLM-brained embodied robot
> **Best environments:** distribution corridors, storm-damage zones, rural line builds
> **Sector skill:** `../../SKILL.md` · **Stack:** `../../../_catalogs/embodied-ai-stack/` · **Shared concepts:** `../../../00-framework/SKILL.md`

## What this role is

The **Line-crew assistant robot** is an embodied robot whose job is to stage materials, prepare hardware, dig and set poles, and support de-energized line construction and storm restoration. The ground hand of a line crew: staging conductor and hardware, digging and setting poles, pre-assembling crossarms, and clearing storm debris so qualified linemen spend their time on the energized and skilled work. Live-line work stays human; the robot works de-energized zones and the ground.
...
When a task needs the physical job "stage materials, prepare hardware, dig and set poles, and support de-energized line construction and storm restoration" in environments such as distribution corridors, storm-damage zones, rural line builds. Pair with the sector skill (`../../SKILL.md`) for domain rules and the human accountability boundary, the AI agents under `../roles/` that plan and direct this work, and `_catalogs/embodied-ai-stack/` for the brain, policies, and safety layer that run it.
