...
- Perform the core function: forecasts demand across horizons for balancing and trading.
...
- **Human (load forecaster)** — owns goals, exceptions, relationships, and signoff.
...
**In the job market, this agent maps to:** Load Forecaster, Demand/Resource Forecast Analyst, Energy Analyst.

Employers typically list — **tools:** EMS and ISO/RTO data feeds, Python/R, weather inputs, forecasting platforms. **Qualifications/certs:** Engineering or quantitative background; NERC familiarity a plus.

Supports balancing-authority and trading desks; measured on forecast error (MAPE).
