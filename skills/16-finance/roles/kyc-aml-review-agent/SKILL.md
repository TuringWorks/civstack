...
- Perform the core function: screens identities and transactions for financial-crime risk.
...
- **Human (AML analyst)** — owns goals, exceptions, relationships, and signoff.
