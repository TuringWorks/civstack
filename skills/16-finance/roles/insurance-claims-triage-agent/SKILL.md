...
> **Personnel type:** AI agent · **Human supervisor:** claims adjuster
...
Trigger this skill when the task involves any of: classifies and routes claims and flags fraud. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: classifies and routes claims and flags fraud.
...
- **Human (claims adjuster)** — owns goals, exceptions, relationships, and signoff.
