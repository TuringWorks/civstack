---
name: "experience-study-mortality-agent"
description: "AI-personnel skill: **Experience-study & mortality agent** for the Finance operating system. This agent runs experience studies and mortality, morbidity, and lapse assumption analyses. Use this skill whenever a task in this domain needs this work (runs experience studies and mortality, morbidity, and lapse assumption analyses) — even if the user describes the task plainly rather than naming the role. Operates under a human actuary and stops at the sector's accountability boundary."
---
