...
- Perform the core function: models plans within suitability constraints.
...
- **Human (wealth advisor)** — owns goals, exceptions, relationships, and signoff.
