...
- Perform the core function: prioritizes and routes incoming reporting and tips.
...
- **Human (threat analyst)** — owns goals, exceptions, relationships, and signoff.
