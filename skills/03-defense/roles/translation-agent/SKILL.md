...
- Perform the core function: translates and contextualizes multilingual material at speed.
...
- **Human (linguist / analyst)** — owns goals, exceptions, relationships, and signoff.
