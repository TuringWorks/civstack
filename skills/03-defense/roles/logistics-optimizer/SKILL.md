...
> **Personnel type:** AI agent · **Human supervisor:** logistics officer
...
Trigger this skill when the task involves any of: plans movement of personnel, materiel, and supply under constraints. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: plans movement of personnel, materiel, and supply under constraints.
...
- **Human (logistics officer)** — owns goals, exceptions, relationships, and signoff.
