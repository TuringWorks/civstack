...
> **Personnel type:** AI agent · **Human supervisor:** cyber operator
...
Trigger this skill when the task involves any of: performs continuous monitoring and incident-response assistance. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: performs continuous monitoring and incident-response assistance.
...
- **Human (cyber operator)** — owns goals, exceptions, relationships, and signoff.
