...
- Perform the core function: triages post-disaster claims and aid requests.
...
- **Human (recovery program manager)** — owns goals, exceptions, relationships, and signoff.
