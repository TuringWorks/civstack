...
- Perform the core function: reviews and tests business-continuity plans.
...
- **Human (business continuity manager)** — owns goals, exceptions, relationships, and signoff.
