...
- **Disaster response robot** — search rubble, clear debris, shore structures, and deliver supplies in hazardous zones under incident command. *(embodied robot skill: `robots/disaster-response-robot/`)*
