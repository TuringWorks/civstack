...
Use it when a task calls for this work: analyzes disengagements, near-misses, and incidents and feeds fixes back into the stack and the ODD. Pair with `_catalogs/autonomous-machines/` (the platforms) and any operating-system skill (01–22) whose fleet this supports.
