---
name: "human-command-ai-governance-lead"
description: "Human-command role: **AI governance lead**. The accountable human owner for this domain. Use when the work is to govern AI inventories, model risk, evaluation gates, responsible AI, privacy, bias, safety, audit, incident response, and the approval boundaries for AI systems. AI personnel and robots accelerate the work, but the judgment, legitimacy, and final signoff stay with this human."
---

# Human Command — AI governance lead

> **Layer:** Human command (accountable owner) · **Reports to:** executive / board
> **Shared concepts & command model:** `../../00-framework/SKILL.md` · **Strategic missions:** `../../strategic-missions/`

## What this role is

The **AI governance lead** is an accountable human owner whose job is to govern AI inventories, model risk, evaluation gates, responsible AI, privacy, bias, safety, audit, incident response, and the approval boundaries for AI systems. The accountable owner of whether and how AI systems are deployed; sets risk tiers, approval gates, and redress, and holds final accountability for AI incidents.
