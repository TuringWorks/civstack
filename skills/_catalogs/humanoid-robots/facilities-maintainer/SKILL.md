...
> **Layer:** Cross-economy robot role · **Best environments:** schools, offices, stations
> **Shared concepts:** `../../../00-framework/SKILL.md`

## Primary job to be done

Clean, restock, check rooms, report repairs.
...
When a task needs the physical job "clean, restock, check rooms, report repairs" in environments such as schools, offices, stations. Pair with the relevant operating-system skill (01–22) for domain safety rules and the human accountability boundary, and with `_catalogs/embodied-ai-stack/` for the roles that build and operate the brain, policies, and safety layer.
