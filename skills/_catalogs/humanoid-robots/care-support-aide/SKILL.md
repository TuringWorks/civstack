...
> **Layer:** Cross-economy robot role · **Best environments:** eldercare, hospitals, homes
> **Shared concepts:** `../../../00-framework/SKILL.md`

## Primary job to be done

Fetch, remind, lift-assist, monitor.
...
When a task needs the physical job "fetch, remind, lift-assist, monitor" in environments such as eldercare, hospitals, homes. Pair with the relevant operating-system skill (01–22) for domain safety rules and the human accountability boundary, and with `_catalogs/embodied-ai-stack/` for the roles that build and operate the brain, policies, and safety layer.
