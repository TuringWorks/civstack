...
> **Layer:** Cross-economy robot role · **Best environments:** brownfield factories
> **Shared concepts:** `../../../00-framework/SKILL.md`

## Primary job to be done

Tend machines, assemble, inspect, rework.
...
When a task needs the physical job "tend machines, assemble, inspect, rework" in environments such as brownfield factories. Pair with the relevant operating-system skill (01–22) for domain safety rules and the human accountability boundary, and with `_catalogs/embodied-ai-stack/` for the roles that build and operate the brain, policies, and safety layer.
