...
> **Human supervisor:** robot learning manager · **Shared concepts:** `../../../00-framework/SKILL.md` · **Robot roles:** `../../humanoid-robots/`

## What this role is

The **VLA policy engineer** trains, evaluates, and maintains the Vision-Language-Action policies that turn instructions and perception into continuous motor control. Owns the 'how' layer beneath the brain: data curation, policy architecture, training, and on-robot evaluation. Balances capability against robustness and the sim-to-real gap.
...
Use this skill when a task calls for this work: trains, evaluates, and maintains the Vision-Language-Action policies that turn instructions and perception into continuous motor control. Pair with `_catalogs/humanoid-robots/` (the physical roles this stack powers) and any operating-system skill (01–22) whose robots this stack will run.
...
- Deliver this role's core job: trains, evaluates, and maintains the Vision-Language-Action policies that turn instructions and perception into continuous motor control.
