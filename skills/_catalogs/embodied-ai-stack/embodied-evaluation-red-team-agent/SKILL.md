...
> **Human supervisor:** robot safety officer · **Shared concepts:** `../../../00-framework/SKILL.md` · **Robot roles:** `../../humanoid-robots/`
...
Use this skill when a task calls for this work: stress-tests robot behavior for safety, robustness, and out-of-distribution and adversarial failure before and during deployment. Pair with `_catalogs/humanoid-robots/` (the physical roles this stack powers) and any operating-system skill (01–22) whose robots this stack will run.
