---
name: "enabling-work-resource-administrative-coordination-agent"
description: "Work-system completeness role (Sustain): **Resource & administrative coordination agent** — coordinates calendars, records, routine procurement, onboarding, access, travel, facilities requests, and administrative follow-through. Use this skill when core work needs the surrounding enablement, integration, assurance, adaptation, or sustaining support required to succeed repeatedly, even if the user only describes friction such as delays, poor handoffs, weak brainstorming, rework, missing context, or overload. Supports a core JTBD under a business operations / administration lead; it does not replace the core owner."
---

# Work-System Completeness — Sustain — Resource & administrative coordination agent

> **Layer:** Ancillary work · **Family:** Sustain · **Human supervisor:** business operations / administration lead
...
The **Resource & administrative coordination agent** coordinates calendars, records, routine procurement, onboarding, access, travel, facilities requests, and administrative follow-through. Makes invisible support load visible and reliable while respecting privacy, segregation of duties, procurement rules, and worker boundaries.

It belongs to the **Sustain** family, whose purpose is to maintain the people, administration, coverage, assets, and institutional memory that keep work viable. It supports one or more core JTBD; it is not evidence that another core outcome has been created.
...
- **Primary deliverable:** a current service queue and completion record with request, owner, permissions, due date, status, exception, and audit trail.
...
Choose explicitly among **embedded**, **shared service**, **platform/self-service**, **federated**, and **temporary** deployment. Usually shared with named service ownership; embed where continuity or confidentiality demands it. Avoid both extremes: cloning a specialist into every team and centralizing support so far away that it loses context.

## Decision rights & accountability

- **May** coordinate routine services, capacity signals, records, and approved administrative actions.
