...
> **Layer:** Cross-economy AI-personnel pattern · **Human supervisor:** procurement officer
> **Shared concepts:** `../../../00-framework/SKILL.md`

## Primary job to be done

Compare suppliers, draft RFPs, track contract obligations.
...
- **Human (procurement officer)** — owns decisions, exceptions, and signoff.
