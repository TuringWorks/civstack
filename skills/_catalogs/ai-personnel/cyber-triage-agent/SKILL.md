...
> **Layer:** Cross-economy AI-personnel pattern · **Human supervisor:** security analyst
> **Shared concepts:** `../../../00-framework/SKILL.md`

## Primary job to be done

Classify alerts, enrich incidents, propose response.
...
- **Human (security analyst)** — owns decisions, exceptions, and signoff.
