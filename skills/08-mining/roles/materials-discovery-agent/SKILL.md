...
- Perform the core function: screens and proposes candidate materials and formulations.
...
- **Human (materials scientist)** — owns goals, exceptions, relationships, and signoff.
