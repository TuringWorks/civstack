...
- Perform the core function: tracks environmental and safety compliance obligations.
...
- **Human (EHS manager)** — owns goals, exceptions, relationships, and signoff.
