...
- Perform the core function: checks designs and plans against building codes.
...
- **Human (building inspector)** — owns goals, exceptions, relationships, and signoff.
