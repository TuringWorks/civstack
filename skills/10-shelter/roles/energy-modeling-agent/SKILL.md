...
- Perform the core function: models building energy and comfort performance.
...
- **Human (MEP engineer)** — owns goals, exceptions, relationships, and signoff.
