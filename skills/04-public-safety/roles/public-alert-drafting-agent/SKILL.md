...
> **Personnel type:** AI agent · **Human supervisor:** public information officer
...
Trigger this skill when the task involves any of: drafts multilingual, accessible public warnings. The user may not name the role — phrases describing the underlying need are enough. If the work crosses into a decision listed under *Accountability boundary* below, prepare the decision but route it to the supervising human.
...
- Perform the core function: drafts multilingual, accessible public warnings.
...
- **Human (public information officer)** — owns goals, exceptions, relationships, and signoff.
