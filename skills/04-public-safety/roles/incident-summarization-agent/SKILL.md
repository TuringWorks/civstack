...
- Perform the core function: maintains a live common operating picture and after-action logs.
...
- **Human (incident commander)** — owns goals, exceptions, relationships, and signoff.
