...
S(1, "Governance, Law, and Public Administration",
  ...
  [("Legislative research agent", "compares laws across jurisdictions, drafts bill language, summarizes testimony and amendments", "policy analyst / legislative counsel"),
   ...
   ("Delivery-unit coordination agent", "tracks cross-ministry delivery against commitments, surfaces implementation bottlenecks, and verifies that decisions actually reach the front line — the engine of a mission-delivery office", "delivery unit lead / chief of staff")],
...
S(2, "Public Finance, Tax, Treasury, and Procurement",
  ...
  ["When public services need funding, collect taxes and fees fairly so the state can operate.",
   ...
   "When a decision binds future generations, price its long-run costs and benefits so the present does not silently borrow from the future.",
  ...
  [("Tax return review agent", "screens returns for errors and anomalies and prepares examiner work files", "tax examiner / revenue agent"),
   ...
   ("Pension & retirement valuation agent", "performs actuarial pension valuations (funding status, PBO/ABO, contribution projections) for review by the plan actuary", "public pension actuary"),
   ("Intergenerational impact analyst", "prices the long-run, cross-generational costs and benefits of major fiscal decisions and flags those that bind future cohorts before signoff", "fiscal policy advisor / chief economist"),
   ("Wellbeing budgeting agent", "scores budget options on a wellbeing frame — health, time, security, life-satisfaction, and distribution — alongside output so spending is judged by lived impact, not output alone", "budget analyst / treasury lead")],
...
S(5, "Food, Agriculture, Fisheries, and Nutrition",
  ...
  [("Crop planning agent", "plans planting, rotation, and inputs against soil, weather, and market data", "agronomist"),
   ...
   ("Forestry & logging operations agent", "plans sustainable harvest, replanting, and logging logistics within stewardship and permit limits", "forester / forestry manager")],
...
S(7, "Energy, Utilities, and Grid Operations",
  ...
  [("Load forecasting agent", "forecasts demand across horizons for balancing and trading", "load forecaster"),
   ...
   ("Generation-buildout planning agent", "plans and sequences clean generation, storage, and transmission ahead of forecast demand and works down the interconnection-queue and permitting backlog", "resource planner / grid planning lead")],
...
S(10, "Shelter, Construction, Land, and the Built Environment",
  ...
  [("Permitting assistant", "guides and pre-checks permit applications against code", "code official"),
   ...
   ("Property listing & valuation agent", "drafts listings and runs comparable-based valuations (AVM) for sale or rent", "real-estate broker"),
   ("Lease abstraction & management agent", "extracts lease terms and tracks obligations, renewals, and escalations", "property manager"),
   ("Tenant screening & onboarding assistant", "screens applicants and prepares onboarding within fair-housing and anti-discrimination limits", "property manager")],
...
S(11, "Transportation, Logistics, Postal, and Mobility",
  ...
  [("Routing optimizer", "optimizes routes and loads against time, cost, and constraints", "logistics coordinator"),
   ...
   ("Port operations & berth-planning agent", "plans berth allocation, terminal slots, and quay/yard operations at ports", "port operations lead"),
   ("Maritime route & weather-routing agent", "plans sea routes and weather routing for vessels and monitors maritime traffic and safety", "marine operations lead")],
...
S(12, "Communications, Software, Cybersecurity, and Digital Infrastructure",
  ...
  [("Coding agent", "builds, tests, refactors, and documents software under review", "engineer / tech lead"),
   ...
   ("Algorithmic transparency & audit agent", "documents, tests, and audits automated public-facing decision systems for explainability, fairness, and appealability and prepares the records that make them reviewable", "AI governance lead / responsible-AI officer")],
...
S(15, "Science, Research, Standards, and Innovation",
  ...
  [("Literature review agent", "surveys, synthesizes, and cites the literature", "principal investigator"),
   ...
   ("Technology-transfer agent", "moves validated discoveries toward firms, licenses, pilot production, standards, and public capability — closing the gap between research and deployed technology", "technology-transfer office director")],
...
S(16, "Finance, Insurance, Payments, and Capital Markets",
  ...
  [("KYC/AML review agent", "screens identities and transactions for financial-crime risk", "AML analyst"),
   ...
   ("Pricing & ratemaking agent", "develops rate-adequacy analyses, GLM-based pricing, and rate-filing support within actuarial standards of practice", "pricing actuary"),
   ("Reserving & loss-development agent", "builds loss-development triangles and IBNR estimates (chain-ladder, Bornhuetter-Ferguson) for the reserving actuary", "reserving actuary"),
   ("Actuarial valuation & solvency-reporting agent", "prepares reserves, capital, and disclosures under IFRS 17, Solvency II, and US Stat/RBC for review by the appointed actuary", "valuation / appointed actuary"),
   ("Experience-study & mortality agent", "runs experience studies and mortality, morbidity, and lapse assumption analyses", "actuary"),
   ("ALM & economic-capital modeling agent", "models asset-liability matching, economic capital, and stress and scenario results", "actuary / risk lead"),
   ("Macro-risk scenario agent", "nowcasts and scenario-models macro-financial risk — inflation, output, credit, and policy consistency — so monetary and fiscal authorities can act on early signals", "chief economist / financial-stability lead"),
   ("External-vulnerability analyst", "monitors reserves, the current account, external debt, and funding concentration and stress-tests exposure to capital-flow and balance-of-payments shocks", "financial-stability lead")],
...
S(17, "Commerce, Retail, Hospitality, and Customer Operations",
  ...
  [("Sales research agent", "researches accounts and prospects and qualifies leads", "account executive"),
   ...
   ("Distribution & allocation agent", "coordinates wholesale distribution, allocations, and backorders across the network", "distribution operations manager"),
   ("Wholesale assortment & replenishment agent", "plans wholesale assortment and replenishment against demand and terms", "buyer / merchandiser"),
   ("Equipment-rental fleet & pricing agent", "manages rental/leasing fleet utilization, availability, and pricing", "rental operations manager"),
   ("Repair-service scheduling & estimate agent", "schedules repair and maintenance jobs and drafts estimates", "service manager")],
...
S(19, "Environment, Climate, Waste, and Resource Stewardship",
  ...
  ["When waste is produced, collect, sort, treat, recycle, compost, landfill, or neutralize it safely.",
   ...
   "When materials reach end-of-life, recover and recirculate them so virgin extraction and waste fall."],
  ...
  [("Emissions accounting agent", "compiles and audits greenhouse-gas inventories", "carbon accounting specialist"),
   ...
   ("Circular-economy material-flow agent", "maps material flows end-to-end and routes end-of-life materials back into production so virgin extraction and waste fall", "circular-economy lead / sustainability manager"),
   ("Natural-capital accounting agent", "books ecosystems, water, soil, and biodiversity as assets on the national balance sheet and tracks their depletion or restoration", "environmental economist")],
...
S(20, "Labor, Workforce Systems, and Organizational Life",
  ...
  [("Job description agent", "drafts and calibrates job descriptions and scorecards", "HR business partner"),
   ...
   ("Corporate development & portfolio agent", "supports M&A screening, portfolio strategy, and corporate-management decisions for holding companies and enterprises", "corporate development lead"),
   ("Strategic skills-gap forecaster", "projects which deep and broad skills the economy will need years ahead and tells education and immigration systems what to build", "workforce planning director")],
...
S(21, "Household, Childcare, Eldercare, and Community Support",
  ...
  [("Family scheduler", "coordinates household calendars, forms, and logistics", "individual / family"),
   ...
   ("Funeral arrangement assistant", "guides families through funeral and cremation arrangements, documents, and logistics with dignity", "funeral director"),
   ("Death registration & estate-handoff assistant", "prepares death registration, certificates, and benefit/estate/account notifications", "funeral director / registrar"),
   ("Bereavement support coordinator", "coordinates grief resources and respectful follow-up for the bereaved", "bereavement counselor"),
   ("Personal-services booking assistant", "schedules and coordinates personal and consumer services (salon, pet care, laundry, home help)", "service owner"),
   ("Pet care & veterinary-coordination assistant", "coordinates companion-animal care, appointments, and veterinary follow-up for households", "pet owner / veterinarian")],
...
S(22, "Resilience, Continuity, and Strategic Foresight",
  ...
  [("Scenario generation agent", "generates and stress-tests future scenarios", "scenario planner"),
   ...
   ("Strategic-reserve optimization agent", "sizes and positions reserves and redundancy for existential inputs (energy, water, food, medicine, payments) against worst-credible shocks", "continuity director / resilience lead")],
